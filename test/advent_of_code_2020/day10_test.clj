...
(deftest get-arrangements-test
  (testing "Should get all possible arrangements"
    (is (= #{(list 0 2 5)}
           (set (get-arrangements (list 0 2 5))
                )))
    (is (= #{(list 0 1 2 5)
             (list 0 2 5)}
           (set (get-arrangements (list 0 1 2 5)))))
    (is (= #{(list 0, 1, 4, 5, 6, 7, 10, 11, 12, 15, 16, 19, 22)
           ...
           (set (get-arrangements (list 0 1 4 5 6 7 10 11 12 15 16 19 22)))))))
